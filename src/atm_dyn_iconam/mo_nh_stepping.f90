...
!
  ...
  USE cpl_oas_interface,           ONLY: destruct_atmo_coupler_OAS
#endif  
      ...
      IF (sstice_mode == SSTICE_INST) THEN
        ...
        DO jg=1, n_dom
          ...
          ELSE
            ...
            ! only update sea/seaice index list after oasis_get (see nh_interface_nwp)
            ! only exlcuded in OASIS version as ICON-XPP is not running with SSTICE_INST
...
#ifdef COUP_OASIS3MCT
  CALL destruct_atmo_coupler_OAS  ! deallocate coupling fieds
#endif
