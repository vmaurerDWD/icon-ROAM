...
!
    ...
    IF ( iforcing == inwp ) THEN
      ...
      ! allocate index list for active NEMO-coupling points (static)
      CALL p_ext_atm%list_sea_nemo%construct(nproma,nblks_c,lopenacc=.TRUE.)
#endif
...
#ifdef COUP_OASIS3MCT
      CALL ext_data(jg)%atm%list_sea_nemo%finalize()
#endif
    ENDDO
